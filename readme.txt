...
Order Sync with Zendesk for WooCommerce will provide a managed process in dealing with new tickets and assembling customers’ order data. This is an integration between Zendesk and WooCommerce where the user needs to install the WooCommerce Orders App (from Zendesk Marketplace) first before one can proceed syncing this plugin. 

Here, Order Sync with Zendesk for WooCommerce plugin will display the ‘top 5 WooCommerce orders details’ of new customers request. It is plainly, zendesk oriented solution which will only work for WooCommerce orders. 
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't need to leave your web browser. To do an automatic install of Order Sync with Zendesk for WooCommerce, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
...
The manual installation method involves downloading our Order Sync with Zendesk for WooCommerce and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](http://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
